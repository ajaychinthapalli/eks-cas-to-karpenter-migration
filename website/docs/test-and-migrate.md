---
id: test-and-migrate
title: "Step 6: Test & Migrate"
sidebar_label: "6. Test & Migrate"
sidebar_position: 7
---
...
```bash
kubectl apply -f https://github.com/ajaychinthapalli/eks-cas-to-karpenter-migration/blob/main/manifests/test-scaleup.yaml   # 5 replicas × 500m CPU request
```
...
constraint. See [troubleshooting.md](troubleshooting#4-vcpulimitexceeded-on-node-launch).
