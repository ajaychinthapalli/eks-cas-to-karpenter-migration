---
id: create-nodeclass-nodepool
title: "Step 5: Create EC2NodeClass & NodePool"
sidebar_label: "5. EC2NodeClass & NodePool"
sidebar_position: 6
---
...
Manifests: [`https://github.com/ajaychinthapalli/eks-cas-to-karpenter-migration/blob/main/manifests/ec2nodeclass.yaml`](https://github.com/ajaychinthapalli/eks-cas-to-karpenter-migration/blob/main/manifests/ec2nodeclass.yaml),
[`https://github.com/ajaychinthapalli/eks-cas-to-karpenter-migration/blob/main/manifests/nodepool.yaml`](https://github.com/ajaychinthapalli/eks-cas-to-karpenter-migration/blob/main/manifests/nodepool.yaml).

## Apply

```bash
kubectl apply -f https://github.com/ajaychinthapalli/eks-cas-to-karpenter-migration/blob/main/manifests/ec2nodeclass.yaml
kubectl apply -f https://github.com/ajaychinthapalli/eks-cas-to-karpenter-migration/blob/main/manifests/nodepool.yaml
```
