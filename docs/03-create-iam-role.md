...
Trust/permission policy JSON files are in [`../policies/`](../policies/).
...
correct provider registered. See [troubleshooting.md](troubleshooting.md#1-oidc-provider-not-registered)
for full detail.

## 3c. Permissions policy on the controller role

The full policy is in [`../policies/controller-permissions-policy.json`](../policies/controller-permissions-policy.json).
